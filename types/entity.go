...
func (Entities) FromJsJSONValue(jsvalue js.Value) Select2ResultAble {
...
func (e Entities) GetRows() []Select2ItemAble {
...
func (e Entity) FromJsJSONValue(jsvalue js.Value) Select2ItemAble {
